...
export const criarTreinamento = onCall({ region: 'southamerica-east1' }, async (request: any) => {
...
export const registrarPresenca = onCall({ region: 'southamerica-east1' }, async (request: any) => {
...
export const emitirCertificado = onCall({ region: 'southamerica-east1' }, async (request: any) => {
  if (!request.auth?.token.admin) {
