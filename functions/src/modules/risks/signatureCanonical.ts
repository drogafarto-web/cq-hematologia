/**
 * signatureCanonical.ts (server — risks module)
 *
...
export type RiskPayload = Record<string, string | number | boolean>;
...
export function sortedStringify(payload: RiskPayload): string {
  const sorted: RiskPayload = {};
...
export function generateRisksSignatureServer(
  operatorId: string,
  payload: RiskPayload,
