...
import { validateStripImageSafe } from '../../shared/ia';
import type { StripUploadResponse, StripClassificationResponse } from './types';
 ...
 */
export const uploadStripImage = functions.onCall(async (request): Promise<StripUploadResponse> => {
 ...
 */
export const getClassificationResult = functions.onCall(async (request): Promise<any> => {
 ...
 */
export const submitClassificationFeedback = functions.onCall(async (request): Promise<any> => {
 ...
 */
export const trainStripClassifier = functions.onRequest(async (req: any, res: any) => {
