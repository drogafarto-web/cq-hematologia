...
export const ec_registrarAvaliacaoEficacia = onCall<unknown, Promise<RegistrarEficaciaResult>>(
  {},
  async (request) => {
...
export const ec_fecharAvaliacaoEficacia = onCall<unknown, Promise<FecharEficaciaResult>>(
  {},
  async (request) => {
    ...
    const acao = (
      input.acaoCorretiva ??
      (atual['acaoCorretiva'] as string | undefined) ??
      ''
    ).trim();
