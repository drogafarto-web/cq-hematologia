...
exports.extractFromBula =
  exports.extractFromImage =
...
function assertSuperAdmin(uid) {
  return __awaiter(this, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [4 /*yield*/, admin.firestore().doc('users/'.concat(uid)).get()];
        case 1:
          snap = _b.sent();
          if (
            !snap.exists ||
            ((_a = snap.data()) === null || _a === void 0 ? void 0 : _a.isSuperAdmin) !== true
          ) {
...
exports.createUser = (0, https_1.onCall)({}, function (request) {
      ...
      switch (_c.label) {
        ...
        case 1:
          ...
          if (!parsed.success) {
            throw new https_1.HttpsError(
              'invalid-argument',
              'Dados inv\u00E1lidos: '.concat(parsed.error.message),
            );
          }
          ((_a = parsed.data),
        ...
        case 5:
          ...
          if (labId && role) {
            batch.set(firestore.doc('labs/'.concat(labId, '/members/').concat(uid)), {
              role: role,
              active: true,
            });
          }
...
exports.setUserDisabled = (0, https_1.onCall)({}, function (request) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        ...
        case 7:
          ...
          return [
            4 /*yield*/,
            admin.firestore().doc('users/'.concat(uid)).update({ disabled: disabled }),
          ];
        case 8:
          // Sync state to Firestore so client can read it without Admin SDK
          _b.sent();
...
var OCR_PROMPT = function (analyteIds) {
...
exports.extractFromImage = (0, https_1.onCall)({ secrets: [geminiApiKey] }, function (request) {
  return __awaiter(void 0, void 0, void 0, function () {
    var _a,
      base64,
      analyteIds,
      ...
      switch (_d.label) {
        ...
        case 3:
          ...
          if (msg.includes('429') || msg.toLowerCase().includes('quota')) {
            throw new https_1.HttpsError(
              'resource-exhausted',
              'Cota da API Gemini excedida. Aguarde alguns instantes.',
            );
          }
          if (msg.toUpperCase().includes('SAFETY')) {
            throw new https_1.HttpsError(
              'invalid-argument',
              'A imagem foi bloqueada por filtros de segurança.',
            );
          }
          throw new https_1.HttpsError(
            'internal',
            'Falha na comunica\u00E7\u00E3o com a IA: '.concat(msg),
          );
        case 4:
          if (!rawText.trim()) {
        ...
        switch (_c.label) {
          ...
          case 4:
            if (!rawText.trim()) {
              throw new https_1.HttpsError(
                'internal',
                'A IA retornou uma resposta vazia. Verifique se o PDF é legível.',
              );
            }
            try {
              parsed = JSON.parse(rawText);
