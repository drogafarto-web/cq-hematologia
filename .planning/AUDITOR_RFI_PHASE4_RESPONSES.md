...
**Auditor Question:** _"How do you prevent token reuse attacks? Can a patient share their auth link with another patient? What prevents CPF spoofing?"_
...
3. **Multi-factor implicit:** CPF + email together form a 2-step verification:
   ...
   - Attacker would need both CPF _and_ email account access to succeed.
...
**Auditor Question:** _"Can patient A view patient B's results? How do you ensure read isolation? Where is LGPD consent documented?"_
...
**Auditor Question:** _"How do you prove NOTIVISA received the laudo correctly? If API submission fails, what's your fallback? Where's the audit trail?"_
...
- **v1.4 (2026-07-15):** Art. 66 _form generation + approval_ ✅ deployed (preparatory compliance).
- **v1.5+ (2026-08 onwards):** Art. 66 _API submission_ (pending certificate provisioning).
...
**Auditor Question:** _"Have you done penetration testing? When will you? What's the scope and timeline?"_
...
**Auditor Question:** _"Where are your ADRs? Risk matrix? Threat model? How do we know all risks are being managed?"_
...
**Auditor Question:** _"You deferred some features to Phase 5. Which ones? Are any of those deferral features regulatory mandates? If so, what's your mitigation?"_
...
**Auditor Question:** _"If Phase 4 breaks in production (portal auth fails, NOTIVISA forms corrupt, audit trail breaks), how do you roll back? What's your incident response?"_
