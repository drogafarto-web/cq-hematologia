...
**How to avoid:** Run **both**. LCI as a gating tool (blocks regressions). RUM (Cloud Monitoring) as the truth. Set LCI thresholds *tighter* than RUM targets (e.g., LCI <1.8s, RUM target <2.5s) to catch problems early.
...
✅ Why the two were described together (cross-module linkage: KPI dashboard *displays* training data, but dashboard ≠ training system)
