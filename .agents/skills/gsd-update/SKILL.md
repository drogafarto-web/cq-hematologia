...
<execution_context>
@$HOME/.qwen/get-shit-done/workflows/update.md
</execution_context>
...
- Otherwise: **Follow the update workflow** from `@$HOME/.qwen/get-shit-done/workflows/update.md`.
...
@$HOME/.qwen/get-shit-done/workflows/sync-skills.md
@$HOME/.qwen/get-shit-done/workflows/reapply-patches.md
</execution_context_extended>
