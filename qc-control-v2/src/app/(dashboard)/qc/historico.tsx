      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-surface-variant">
            <th className="text-xs uppercase tracking-wider text-on-surface-variant text-left px-4 py-3 font-semibold">
              Controle
            </th>
            <th className="text-xs uppercase tracking-wider text-on-surface-variant text-left px-4 py-3 font-semibold">
              Data
            ...
            <th className="text-xs uppercase tracking-wider text-on-surface-variant text-right px-4 py-3 font-semibold">
              Protrombina
            </th>
        ...
        <tbody>
          {todosRegistros.map((r) => {
            const sProt = statusDe(
              Number(r.valorProtrombina),
              r.controle.protrombinaMin,
              r.controle.protrombinaMax,
            );
            ...
            return (
              <tr key={r.id} className="border-t border-border hover:bg-surface-variant/40">
                <td className="px-4 py-3 font-mono text-xs">
                  {r.controle.nome}
                  <span className="text-on-surface-variant"> · {r.controle.lote}</span>
                </td>
                ...
                <td className="px-4 py-3 font-mono text-right">
                  {formatDecimal(r.valorProtrombina)}
                </td>
