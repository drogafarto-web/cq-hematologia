...
function EyeIcon({ off }: { off: boolean }) {
  return off ? (
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      <path
        d="M2 2l12 12M6.5 6.6A2 2 0 009.4 9.5M4.5 4.6C3.1 5.5 2 6.9 2 8c0 1.7 2.7 5 6 5a7 7 0 002.9-.7M6.7 3.1A7 7 0 0114 8c-.4 1-1.1 2-2 2.7"
        stroke="currentColor"
        strokeWidth="1.3"
        strokeLinecap="round"
      />
    ...
    <svg width="14" height="14" viewBox="0 0 16 16" fill="none" aria-hidden>
      <path
        d="M2 8c0-1.7 2.7-5 6-5s6 3.3 6 5-2.7 5-6 5-6-3.3-6-5z"
        stroke="currentColor"
        strokeWidth="1.3"
      />
        ...
        <form onSubmit={handleSubmit} noValidate>
          ...
          <div className="px-6 py-4 border-t border-white/[0.07] flex gap-3">
            ...
            <button
              type="submit"
              disabled={
                loading || success || !displayName.trim() || !email.trim() || password.length < 8
              }
