...
export function WizardAuditoria({ auditoriaId, onBack }: WizardAuditoriaProps) {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Save status indicator */}
      {saveStatus === 'saved' && (
        <div className="flex items-center gap-1.5 self-end text-emerald-500 dark:text-emerald-400 transition-opacity duration-300" role="status" aria-live="polite">
        ...
        <>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-200 dark:border-white/[0.06]">
            ...
            <button
              ...
              aria-label={currentBlocoIndex === BLOCOS.length - 1 ? 'Ver resumo' : 'Próximo bloco'}
            >
