            ...
            <>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  >
                    <span className={`text-xs font-semibold ${tipoAlteracao === 'minor' ? 'text-violet-300' : 'text-white/70'}`}>
                      Correção / Ajuste
                    </span>
                    <span className="text-[10px] text-white/40 mt-0.5">
                      {formatVersao(documento.versao)} → {formatVersao(incrementVersao(documento.versao, 'minor'))}
                    </span>
                    <span className="text-[10px] text-white/30 mt-1">
                      Nomes, typos, formatação
                    </span>
                  </button>
                  <button
                    type="button"
                  ...
                  >
                    <span className={`text-xs font-semibold ${tipoAlteracao === 'major' ? 'text-violet-300' : 'text-white/70'}`}>
                      Revisão Estrutural
                    </span>
                    <span className="text-[10px] text-white/40 mt-0.5">
                      {formatVersao(documento.versao)} → {formatVersao(incrementVersao(documento.versao, 'major'))}
                    </span>
                    <span className="text-[10px] text-white/30 mt-1">
                      Método, escopo, fluxo
                    </span>
                ...
                {diffSugestao && (
                  <div className="mt-2 rounded-md border border-white/[0.06] bg-white/[0.02] px-3 py-2">
                    <p className="text-[10px] text-white/40">
                      ...
                      {' '}
                      <span className={diffSugestao.sugestao === 'major' ? 'text-amber-300' : 'text-emerald-300'}>
                        {diffSugestao.sugestao === 'major' ? 'Revisão Estrutural' : 'Correção/Ajuste'}
                      </span>
                    </p>
                  </div>
                )}
