...
export function GUTForm({ initialData, onSave, onCancel, saving }: Props) {
  ...
  const sorted = [...itens]
    .map((item, idx) => ({ ...item, idx, score: getScore(item) }))
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          placeholder="Com base no ranking, qual problema será tratado primeiro e por quê?"
