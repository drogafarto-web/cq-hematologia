...
export const SEED_DOCUMENTOS_INTERNOS: SeedDocumento[] = [
  ...
  },
  {
    ...
    listaDistribuicao: ['Qualidade', 'Recepção', 'RH', 'Mercês', 'Silveirânia', 'Guarani'],
  },
  {
    tipo: 'PQ',
    codigo: 'PQ-007',
  ...
  },
  {
    ...
    listaDistribuicao: ['Qualidade', 'Coleta', 'Área Técnica', 'Mercês', 'Silveirânia', 'Guarani'],
  },
  {
    tipo: 'PQ',
    codigo: 'PQ-018',
  ...
  },
  {
    ...
    listaDistribuicao: ['Qualidade', 'Recepção', 'Coleta', 'Mercês', 'Silveirânia', 'Guarani'],
  },
  {
    tipo: 'PQ',
    codigo: 'PQ-020',
