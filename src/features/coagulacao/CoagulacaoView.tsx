...
const CoagIcon      = () => <svg width="15" height="15" viewBox="0 0 20 20" fill="none" aria-hidden><path d="M2.5 10C4 7 6 13 8 10C10 7 12 13 14 10C15.5 7.5 17 10 17.5 10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none"/></svg>;
...
function Sidebar({
  activeLab, userName, userRole, signOut,
  lots, activeLotId, setActiveLotId, onNewRun, setCurrentView,
}: SidebarProps) {
    ...
    <aside className="w-[232px] shrink-0 bg-white dark:bg-[#0F1318] border-r border-slate-200 dark:border-white/[0.06] flex flex-col h-screen sticky top-0 overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto py-3 px-2">
        ...
        <div className="flex items-center gap-2 px-2.5 py-2 mb-1">
          <span className="text-rose-500 dark:text-rose-400"><CoagIcon/></span>
          <span className="text-[13px] font-semibold text-slate-700 dark:text-white/80">Coagulação</span>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between gap-2">
                      <span className={`text-[13px] font-medium truncate ${isActive ? 'text-rose-800 dark:text-rose-300' : 'text-slate-700 dark:text-white/75'}`}>
                        Nível {lot.nivel}
                      </span>
