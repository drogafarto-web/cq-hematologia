...
export const UroInputField = forwardRef<HTMLInputElement, UroInputFieldProps>(
  function UroInputField(
    {
      label,
      hint,
      error,
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <div className={wrapperClasses}>
          ...
          {loading && (
            <span className="pr-3.5 shrink-0" aria-label="Carregando" role="status">
