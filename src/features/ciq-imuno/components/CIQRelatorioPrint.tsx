...
export function CIQRelatorioPrint({ lot, runs, onClose }: CIQRelatorioPrintProps) {
  ...
  const decisionLabel =
    ...
    lot.ciqDecision === 'Rejeitado' ? 'Reprovado' : 'Pendente';
  const decisionColor =
    lot.ciqDecision === 'A'         ? '#059669' :
    lot.ciqDecision === 'Rejeitado' ? '#dc2626' : '#9ca3af';
  ...
  return (
    <div style={{
      ...
      overflowY: 'auto', paddingBlock: 32,
    }}>
      ...
      <div style={{
        ...
        <button
          ...
          onClick={() => handlePrint()}
          style={{
            padding: '7px 20px', background: '#059669', color: 'white',
      ...
      <div
        ref={contentRef}
        style={{
          width: 900, background: 'white', color: '#111827',
              ...
              <tr>
                ...
                <td style={{
                  color: lot.lotStatus === 'reprovado' ? '#dc2626'
                       ...
                       : lot.lotStatus === 'valido'    ? '#059669' : '#9ca3af',
                  fontWeight: 600,
                }}>
          ...
          <table style={{ fontSize: 8.5 }}>
            ...
            <tbody>
              {sorted.map((run) => {
                ...
                const dateStr  = run.createdAt ? fmtTsDate(run.createdAt) : fmtDate(run.dataRealizacao);
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 8, color: '#d1d5db', marginTop: 2 }}>
                Este código identifica unicamente este relatório para fins de rastreabilidade regulatória.
        ...
        <footer style={{
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 8, color: '#9ca3af', lineHeight: 1.5 }}>
              ...
              a Lei Geral de Proteção de Dados Pessoais (LGPD — Lei 13.709/2018) e com a RDC 978/2025 da ANVISA.
              Os dados pessoais presentes neste relatório são tratados exclusivamente para fins de rastreabilidade
              e cumprimento de obrigações regulatórias. Acesso restrito a profissionais autorizados.
              Retenção documental: mínimo 5 anos.
            </div>
            <div style={{
