...
const MODULES: ModuleDef[] = [
  ...
  },
  {
    id: 'coagulation-v2',
    name: 'Coagulação v2',
    tagline: 'Novo CIQ · 3 analitos · design simplificado',
    bullets: ['Controle único', 'AP · RNI · TTPA', 'Westgard automático'],
    icon: <CoagIcon />,
    bloco: 'Bloco 4',
  ...
  },
  {
    ...
    bullets: ['Organograma + cargos', 'Dossiê por colaborador', 'Qualificações vinculadas'],
    icon: <PeopleIcon />,
    bloco: 'Bloco 2',
  ...
  },
  {
    id: 'reclamacoes',
    name: 'Reclamações',
    tagline: 'Intake de reclamações · Classificação IA · NPS pós-resolução',
    bullets: ['DICQ 4.8 · CDC 30 dias', '5 Porquês + NC automática', 'Satisfação NPS integrada'],
    icon: <AlertOctaIcon />,
    bloco: 'Bloco 5',
  ...
  },
  {
    ...
    status: 'active',
    category: 'sgq',
    view: 'pre-pos-analitico' as View,
  },
  {
