      ...
      <div className="relative w-full max-w-md rounded-lg border border-white/10 bg-slate-900 p-6 shadow-lg">
        ...
        {state === 'idle' && !selectedFile && (
          <div className="space-y-4">
            ...
            >
              ...
              <p className="mb-2 text-sm font-medium text-white">Arraste um arquivo aqui</p>
        ...
        {state === 'uploading' && (
          <div className="space-y-4">
            ...
            <p className="text-center text-xs text-gray-400">{Math.round(progress)}%</p>
          </div>
        )}
        ...
        {state === 'done' && (
          <div className="space-y-3">
            ...
            <p className="text-center text-xs text-gray-400">Fechando em alguns segundos...</p>
          </div>
        )}
