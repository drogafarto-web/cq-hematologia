...
*Repeat for Auditoria, Treinamentos, Biosseguranca*
...
### Web Vitals
- **LCP:** ___ ms (target: <2500ms) [GOOD|NEEDS-IMPROVEMENT|POOR]
- **INP:** ___ ms (target: <200ms) [GOOD|NEEDS-IMPROVEMENT|POOR]
- **CLS:** ___ (target: <0.1) [GOOD|NEEDS-IMPROVEMENT|POOR]

### Interactions
- **List Load:** ___ ms
- **Dialog/Details Open:** ___ ms
- **Click-to-Interactive:** ___ ms
