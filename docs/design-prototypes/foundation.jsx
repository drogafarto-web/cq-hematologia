        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-[13px] max-w-prose" style={{ color: 'var(--text-muted)' }}>
              Linguagem visual unificada para os {'>'}50 módulos do sistema. Light + dark mode
              nativos, tokens semânticos, tipografia técnica. Inspirado em Linear, Stripe e Vercel —
        ...
        <div className="mt-8 grid grid-cols-3 gap-6">
          ...
          <section>
            ...
            <div className="space-y-3 mt-4">
              <TypeRow label="h1 · página" size="20px" weight="600" tracking="-0.02em">
                Visão geral · Labclin
              </TypeRow>
              <TypeRow label="h2 · seção" size="14px" weight="600">
                Operação em andamento
              </TypeRow>
              <TypeRow label="body" size="13px" weight="400">
                Terça-feira, 13 de maio de 2026
              </TypeRow>
              <TypeRow label="label" size="10px" weight="600" upper tracking="0.06em">
                Westgard ativos
              </TypeRow>
              <TypeRow label="mono · numérico" size="13px" weight="500" mono>
                13.62 g/dL · z +0.79
              </TypeRow>
            </div>
            <div className="mt-4 text-[10.5px]" style={{ color: 'var(--text-faint)' }}>
              <span className="font-mono">Inter · JetBrains Mono</span> — substituíveis pelo painel
              de Tweaks.
            </div>
          </section>
          ...
          <section>
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              <Swatch
                label="Accent"
                tokens={['accent-50', 'accent-500', 'accent-600', 'accent-700']}
              />
              ...
              {[
                ...
                .map((c, i) => (
                  <div
                    ...
                    style={{ background: c, border: '1px solid var(--border-soft)' }}
                  />
                ))}
            </div>
          </section>
          ...
          <div className="mt-4 grid grid-cols-4 gap-4">
            ...
            <Card title="Botões" padded>
              <div className="space-y-2">
                ...
                <Btn kind="danger" size="md" className="w-full justify-center">
                  Destrutivo
                </Btn>
              </div>
            </Card>
            ...
            <Card title="Formulário" className="col-span-2">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label
                    className="block text-[10.5px] font-semibold mb-1.5"
                    style={{ color: 'var(--text-strong)' }}
                  >
                    Lote *
                  </label>
                  <select
                    className="w-full px-2.5 h-9 rounded-md text-[12.5px]"
                ...
                <div>
                  ...
                  <input
                    defaultValue="13.62"
                    className="w-full px-2.5 h-9 rounded-md font-mono text-[13px]"
            ...
            <Card title="Empty state" className="col-span-2">
              <div
                className="p-6 dot-grid rounded-md flex flex-col items-center text-center"
              ...
              >
                ...
                <div className="mt-1 text-[11.5px]" style={{ color: 'var(--text-muted)' }}>
                  Importe uma bula ou cadastre manualmente para começar.
                </div>
                <Btn kind="primary" size="sm" className="mt-3" icon={<I.Plus size={12} />}>
                  Novo lote
                </Btn>
              </div>
            </Card>
...
function Heading({ kicker, title }) {
  return (
    <div
      className="flex items-baseline gap-2 border-b pb-2"
...
function TypeRow({ label, size, weight, tracking, upper, mono, children }) {
  return (
    <div className="flex items-baseline gap-3">
      <span className="text-[10px] font-mono w-28 shrink-0" style={{ color: 'var(--text-faint)' }}>
        {label}
      </span>
      <span
        style={{
...
function Swatch({ label, tokens }) {
  return (
    <div>
      <div className="text-[10px] font-mono mb-1" style={{ color: 'var(--text-faint)' }}>
        {label}
      </div>
      <div
      ...
      >
        {tokens.map((t) => (
          <div key={t} className="flex-1 h-9" style={{ background: `var(--${t})` }} />
        ))}
      </div>
    </div>
  );
