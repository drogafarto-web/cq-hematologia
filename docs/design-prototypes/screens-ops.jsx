...
function EquipamentosScreen() {
  return (
    <Shell page="equipamentos">
      <PageHeader
        title="Equipamentos & calibração"
        subtitle="34 ativos · 3 calibrações a vencer em 7 dias · 1 vencida"
        actions={
          <>
            <Btn kind="secondary" size="md" icon={<I.Download size={13} />}>
              Inventário
            </Btn>
            <Btn kind="primary" size="md" icon={<I.Plus size={13} />}>
              Cadastrar
            </Btn>
          </>
        }
          ...
          actions={
            <Seg
              options={[
                ...
                { value: 'bioq', label: 'Bioq' },
                { value: 'coag', label: 'Coag' },
                { value: 'imuno', label: 'Imuno' },
              ]}
              active="todos"
            />
          }
            ...
            <thead>
              <tr style={{ color: 'var(--text-faint)' }}>
                {[
                  ...
                  <th
                    key={i}
                    className={`text-${i > 3 && i < 8 ? 'left' : i === 8 ? 'right' : 'left'} text-[10px] uppercase tracking-wider font-semibold py-2.5 ${i === 0 ? 'pl-5' : ''} ${i === 8 ? 'pr-5' : ''}`}
                  >
                    {h}
                  </th>
                ))}
            ...
            <tbody>
              {EQUIPS.map((e, i) => (
                <tr key={i} style={{ borderTop: '1px solid var(--border-hairline)' }}>
                  ...
                  <td className="py-3" style={{ color: 'var(--text-body)' }}>
                    {e.sector}
                  </td>
                  <td className="py-3 font-mono text-[11px]" style={{ color: 'var(--text-muted)' }}>
                    {e.sn}
                  </td>
                  <td className="py-3" style={{ color: 'var(--text-body)' }}>
                    {e.mfr}
                  ...
                  <td className="py-3 font-mono tabular-nums" style={{ color: 'var(--text-body)' }}>
                    {e.mtbf}h
                  </td>
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Btn kind="secondary" size="md" icon={<I.Print size={13} />}>
              Imprimir mapa
            </Btn>
          </>
        }
      ...
      <div className="px-8 py-5 grid grid-cols-[1fr_360px] gap-5 h-[calc(100%-100px)] overflow-auto">
        <div className="space-y-4 min-w-0">
          <div className="grid grid-cols-3 gap-3">
            <SensorCard
              name="Geladeira reagentes"
              id="T-04"
              temp="6.2"
              range="2 – 8 °C"
              alert
              tempColor="var(--warning-500)"
            />
            <SensorCard
              name="Freezer -20°C · A"
              id="T-07"
              temp="-18.4"
              range="-25 – -15 °C"
              tempColor="var(--success-500)"
            />
            <SensorCard
              name="Sala bioquímica"
              id="T-11"
              temp="21.4"
              range="18 – 24 °C"
              tempColor="var(--success-500)"
          ...
          <Card padded={false}>
            ...
            >
              <div>
                <div
                  ...
                  style={{ color: 'var(--text-faint)' }}
                >
                  Geladeira reagentes · T-04
                </div>
                <div className="mt-1 flex items-center gap-3 font-mono text-[12px]">
                  <span style={{ color: 'var(--text-body)' }}>
                    Pico <strong style={{ color: 'var(--warning-500)' }}>9.4 °C</strong> às 04:18
                  </span>
              ...
              <div className="ml-auto flex items-center gap-2">
                <Seg
                  ...
                  active="24h"
                />
                <Btn kind="ghost" size="sm" icon={<I.Sync size={12} />}>
                  ao vivo
                </Btn>
              </div>
            </div>
            <TempChart />
            <div
              className="px-5 pb-3 flex items-center gap-4 text-[10.5px]"
              style={{ color: 'var(--text-faint)' }}
            >
              <span className="flex items-center gap-1.5">
                <span className="w-2 h-px" style={{ background: 'var(--accent-600)' }} />
                Leitura
              </span>
              <span className="flex items-center gap-1.5">
                <span className="w-2 h-px" style={{ background: 'var(--success-500)' }} />
                Faixa aceita
              </span>
              <span className="flex items-center gap-1.5">
                <span className="w-2 h-px" style={{ background: 'var(--warning-500)' }} />
                Limite superior
              </span>
              <span className="ml-auto font-mono">
                12 pontos · 1 leitura / 5 min · sensor Sitrad PRO
              </span>
            </div>
          </Card>
        </div>
        ...
        <aside className="space-y-4">
              ...
              {[
                {
                  tone: 'warning',
                  title: 'Excursão T-04',
                  body: '9.4 °C às 04:18 · 12 min',
                  when: 'há 3h',
                },
                {
                  tone: 'neutral',
                  title: 'Calibração T-07',
                  body: 'Aprovada · padrão NIST',
                  when: 'ontem 18:30',
                },
                {
                  tone: 'success',
                  title: 'Retorno à faixa T-04',
                  body: '6.8 °C às 04:30',
                  when: 'há 3h',
                },
                {
                  tone: 'neutral',
                  title: 'Bateria sensor T-09',
                  body: '12% restante',
                  when: 'há 1d',
                },
              ].map((e, i) => (
          ...
          <Card title="Mapa de risco">
              ...
              {Array.from({ length: 12 }).map((_, i) => {
                ...
                return (
                  <div
                    ...
                    style={{
                      background: t === 'warning' ? 'var(--warning-50)' : 'var(--success-50)',
            ...
            <div className="mt-3 text-[11px]" style={{ color: 'var(--text-muted)' }}>
              <strong style={{ color: 'var(--text-strong)' }}>11</strong> de 12 sensores dentro da
              faixa nas últimas 24h.
            </div>
          </Card>
        </aside>
      </div>
  ...
  return (
    <div
      ...
      style={{
        ...
        border: alert ? '1px solid var(--warning-500)' : '1px solid var(--border-soft)',
      }}
    >
      ...
      <div className="mt-1.5 text-[12.5px] font-medium" style={{ color: 'var(--text-strong)' }}>
        {name}
      </div>
      ...
      <div className="mt-1 text-[10.5px] font-mono" style={{ color: 'var(--text-faint)' }}>
        {range}
      </div>
    </div>
  );
  ...
  return (
    <svg viewBox={`0 0 ${W} ${H}`} className="w-full h-[260px]">
      <rect
        ...
        y={yToPx(ok.hi)}
        width={innerW}
        height={yToPx(ok.lo) - yToPx(ok.hi)}
        fill="var(--success-50)"
      />
      <line
        x1={padL}
          ...
          <Card title="Matriz · setor × trilha" className="col-span-2" padded={false}>
            <div className="overflow-x-auto">
              <table className="w-full text-[12px]">
                <thead>
                  <tr style={{ color: 'var(--text-faint)' }}>
                    <th className="text-left text-[10px] uppercase tracking-wider font-semibold py-3 pl-5 w-[140px]">
                      Trilha
                    </th>
                    {SECTORS.map((s) => (
                      <th
                        key={s}
                        className="text-center text-[10px] uppercase tracking-wider font-semibold py-3 px-2"
                      >
                        {s}
                      </th>
                    ))}
            ...
            <div
              className="px-5 py-3 flex items-center gap-4 text-[10.5px]"
              style={{ color: 'var(--text-faint)', borderTop: '1px solid var(--border-hairline)' }}
            >
              <span className="flex items-center gap-1.5">
                <span
          ...
          <Card title="Próximos vencimentos" padded={false}>
            <ul>
              {[
                {
                  who: 'Carlos Marques',
                  what: 'NR-32 · Resíduos biológicos',
                  due: 'D-2',
                  tone: 'danger',
                },
                ...
                {
                  who: 'Diego R.',
                  what: 'Boas práticas laboratoriais',
                  due: 'D-8',
                  tone: 'warning',
                },
                ...
                >
                  <div
                    className="w-7 h-7 rounded-md flex items-center justify-center text-[10px] font-semibold text-white shrink-0"
...
function RiscosScreen() {
  return (
    <Shell page="riscos">
      <PageHeader
        title="Gestão de riscos · matriz 5×5"
          ...
          <ul>
            {RISKS.map((r, i) => (
              ...
              >
                ...
                <span
                  className="w-7 h-7 rounded shrink-0 flex items-center justify-center text-[11px] font-mono font-semibold"
                  style={{ background: riskColor(r.p * r.i, 0.16), color: riskColor(r.p * r.i, 1) }}
                >
                  {r.p * r.i}
                </span>
              </li>
  ...
  return (
    <div>
      <div className="flex">
        <div className="w-12" />
        <div
          className="flex-1 grid grid-cols-5 gap-1.5 text-[10px] uppercase tracking-wider text-center font-semibold"
          style={{ color: 'var(--text-faint)' }}
        >
          {['Insig.', 'Menor', 'Mod.', 'Maior', 'Sev.'].map((l) => (
            <div key={l}>{l}</div>
          ))}
        </div>
      </div>
      <div className="flex mt-1.5">
        <div
          className="w-12 flex flex-col-reverse justify-between text-[10px] uppercase tracking-wider font-semibold py-2"
          style={{ color: 'var(--text-faint)' }}
        >
          {['Raro', 'Improv.', 'Possível', 'Provável', 'Quase certo'].map((l) => (
            <div key={l} className="-rotate-90 origin-center whitespace-nowrap h-0">
              {l}
            </div>
          ))}
        </div>
        <div className="flex-1 grid grid-cols-5 grid-rows-5 gap-1.5 matrix-grid">
          {Array.from({ length: 25 }).map((_, i) => {
            ...
            return (
              <div
                key={i}
                className="aspect-square rounded flex items-center justify-center text-[14px] font-mono font-semibold relative"
                style={{
                  background: riskColor(score, 0.12),
                  color: count ? riskColor(score, 1) : 'transparent',
                  border: '1px solid ' + riskColor(score, 0.25),
                }}
              >
                {count > 0 ? count : ''}
              </div>
      ...
      <div
        className="mt-4 flex items-center gap-4 text-[10.5px]"
        style={{ color: 'var(--text-faint)' }}
      >
        <span className="flex items-center gap-1.5">
          <span
            className="w-3 h-3 rounded"
            style={{ background: riskColor(2, 0.18), border: `1px solid ${riskColor(2, 0.3)}` }}
          />
          Baixo
        </span>
        <span className="flex items-center gap-1.5">
          <span
            className="w-3 h-3 rounded"
            style={{ background: riskColor(6, 0.18), border: `1px solid ${riskColor(6, 0.3)}` }}
          />
          Atenção
        </span>
        <span className="flex items-center gap-1.5">
          <span
            className="w-3 h-3 rounded"
            style={{ background: riskColor(10, 0.18), border: `1px solid ${riskColor(10, 0.3)}` }}
          />
          Alto
        </span>
        <span className="flex items-center gap-1.5">
          <span
            className="w-3 h-3 rounded"
            style={{ background: riskColor(20, 0.18), border: `1px solid ${riskColor(20, 0.3)}` }}
          />
          Crítico
        </span>
...
const RISKS = [
  {
    id: 'R-014',
    title: 'Falha do equipamento principal sem backup',
    desc: 'Cobas c311 único para CRE/GLU. Sem redundância imediata.',
    p: 4,
    i: 5,
    owner: 'Renata C.',
    action: 'Mitigação · contratar backup',
  },
  {
    id: 'R-009',
    title: 'Vazamento de dados via portal médico',
    desc: 'Token JWT com escopo amplo · refresh > 24h',
    p: 3,
    i: 5,
    owner: 'Diego R.',
    action: 'Aceitar · revisão Q3',
  },
  {
    id: 'R-021',
    title: 'Excursão T-04 não monitorada',
    desc: 'Sensor com bateria < 20% · alerta tardio',
    p: 5,
    i: 4,
    owner: 'Carlos M.',
    action: 'Mitigação · troca em D-3',
  },
  {
    id: 'R-031',
    title: 'CAPA não fechada em prazo legal',
    desc: '2 CAPAs vencidas > 30d · risco regulatório',
    p: 4,
    i: 4,
    owner: 'Renata C.',
    action: 'Tratar · sprint Q2',
  },
];
      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Btn kind="primary" size="md" icon={<I.Check size={13} />}>
              Liberar selecionados (3)
            </Btn>
          </>
        }
        tabs={[
      ...
      >
        <Seg
          options={[
            ...
            { value: 'urg', label: 'Urgência' },
            { value: 'rot', label: 'Rotina' },
          ]}
          active="all"
        />
        <Seg
        ...
        <span className="ml-auto text-[11px]" style={{ color: 'var(--text-muted)' }}>
          <strong className="font-semibold tabular-nums" style={{ color: 'var(--text-strong)' }}>
            3
          </strong>{' '}
          selecionadas
        </span>
      ...
      <div className="overflow-auto h-[calc(100%-180px)]">
        <table className="w-full text-[12.5px]">
          <thead className="sticky top-0 z-10" style={{ background: 'var(--surface-card)' }}>
            ...
            >
              <th className="text-left text-[10px] uppercase tracking-wider font-semibold py-3 pl-8 w-[36px]">
                <input type="checkbox" />
              </th>
              <th className="text-left text-[10px] uppercase tracking-wider font-semibold py-3">
                Amostra · Paciente
              </th>
              <th className="text-left text-[10px] uppercase tracking-wider font-semibold py-3">
                Exames
              ...
              <th className="text-right text-[10px] uppercase tracking-wider font-semibold py-3 pr-8">
                Coletada há
              </th>
            </tr>
          </thead>
            ...
            {LIB.map((r, i) => (
              <tr
                ...
                style={{
                  ...
                  background: r.selected ? 'var(--accent-tint)' : 'transparent',
                }}
              >
                <td className="py-3 pl-8">
                  <input type="checkbox" defaultChecked={r.selected} />
                </td>
                <td className="py-3">
                  <div className="font-mono text-[11.5px]" style={{ color: 'var(--text-strong)' }}>
                    {r.code}
                  </div>
                ...
                <td
                  className="py-3 pr-8 text-right font-mono text-[11.5px]"
                  style={{ color: r.lateTone || 'var(--text-body)' }}
                >
                  {r.collected}
                </td>
              </tr>
...
const LIB = [
  {
    code: 'AM-2026-44811',
    patient: 'Carlos S., 62 anos · M',
    exams: ['HGB', 'HCT', 'PLT', 'GLU', 'CRE'],
    status: 'OK',
    alerts: [{ t: 'urgente', tone: 'warning' }],
    collected: '42 min',
    selected: true,
  },
  {
    code: 'AM-2026-44812',
    patient: 'Mariana A., 35 anos · F',
    exams: ['TSH', 'T4L', 'GLU'],
    status: 'OK',
    alerts: [],
    collected: '1h 12m',
  ...
  {
    code: 'AM-2026-44813',
    patient: 'João P., 71 anos · M',
    exams: ['CRE', 'UREA', 'K', 'Na'],
    status: 'Bloqueada',
    alerts: [{ t: '1-3s CRE', tone: 'danger' }],
    collected: '1h 24m',
  },
  {
    code: 'AM-2026-44814',
    patient: 'Ana B., 28 anos · F',
    exams: ['TP', 'TTPA', 'INR'],
    status: 'OK',
    alerts: [],
    collected: '58 min',
  ...
  {
    code: 'AM-2026-44815',
    patient: 'Rafael L., 53 anos · M',
    exams: ['GLU', 'HBA1C', 'CRE'],
    status: 'Crítica',
    alerts: [
      { t: 'GLU 412', tone: 'danger' },
      { t: 'crítico', tone: 'danger' },
    ],
    collected: '34 min',
  },
  {
    code: 'AM-2026-44816',
    patient: 'Beatriz N., 19 anos · F',
    exams: ['HGB', 'HCT', 'RBC', 'PLT'],
    status: 'OK',
    alerts: [],
    collected: '2h 4m',
    lateTone: 'var(--warning-500)',
  },
  {
    code: 'AM-2026-44817',
    patient: 'Pedro M., 44 anos · M',
    exams: ['CRE', 'UREA'],
    status: 'Pendente',
    alerts: [{ t: 'aguarda 2ª medida', tone: 'warning' }],
    collected: '1h 51m',
  },
  {
    code: 'AM-2026-44818',
    patient: 'Lucia F., 67 anos · F',
    exams: ['HGB', 'HCT', 'PLT'],
    status: 'OK',
    alerts: [],
    collected: '15 min',
