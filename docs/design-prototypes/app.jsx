...
function App() {
  ...
  const wrap = (Component, props = {}) => (
    <div data-density={t.density}>
      <Component dark={dark} accent={accent} density={t.density} {...props} />
    </div>
  );
  ...
  const wrapForce = (Component, forceDark, props = {}) => (
    <div data-density={t.density}>
      <Component dark={forceDark} accent={accent} density={t.density} {...props} />
    </div>
  );
  ...
  const Themed = ({ children, force }) => (
    <div
      className={(force ?? dark) ? 'dark' : ''}
      data-density={t.density}
      style={{ ...artboardStyle, width: '100%', height: '100%' }}
    >
      {children}
    </div>
  );
  ...
  return (
    <>
      <DesignCanvas
        title="hc-quality · Telas unificadas"
      ...
      >
        ...
        <DCSection
          id="fnd"
          title="Foundation"
          subtitle="Tokens, tipografia, componentes-chave do design system"
        >
          <DCArtboard id="fnd-1" label="Foundation · light / dark sync" width={1440} height={900}>
            <Themed>
              <FoundationCard dark={dark} accent={accent} />
            </Themed>
          </DCArtboard>
        </DCSection>
        ...
        <DCSection
          id="cmp"
          title="Claro × Escuro"
          subtitle="A mesma tela em ambos os modos. Toggle global do Tweaks afeta as outras seções."
        >
        ...
        <DCSection
          id="op"
          title="Operação CQI"
          subtitle="Hub, Analyzer, Nova corrida — fluxos do dia a dia do biomédico"
        >
        ...
        <DCSection
          ...
          subtitle="NC, CAPA, auditoria trail, NOTIVISA"
        >
          <DCArtboard
            id="ql-nc"
            label="Não conformidades · lista + detalhe"
            width={1440}
            height={900}
          >
            <Themed>
        ...
        <DCSection
          id="ops"
          title="Operacional"
          subtitle="Equipamentos, temperatura, treinamentos, riscos, liberação"
        >
        ...
        <DCSection
          id="tab"
          title="Tablet 1024"
          subtitle="Sidebar colapsada — adaptação para uso à bancada"
        >
        ...
        <DCSection
          id="mob"
          title="Mobile 390"
          subtitle="App mobile (RN) — Hub e detalhe de NC. Frame ilustra a chrome do dispositivo."
        >
