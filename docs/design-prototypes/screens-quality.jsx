  ...
  return (
    <Shell page="nc">
      ...
      >
        ...
        <Seg
          options={[
            { value: 'tdos', label: 'Todos setores' },
        ...
        >
          <input
            placeholder="Filtrar por título, ID, lote…"
            className="w-72 px-3 h-8 rounded-md text-[12px]"
            style={{ background: 'var(--surface-muted)', color: 'var(--text-body)' }}
          />
          <Btn kind="ghost" size="md" icon={<I.Filter size={13} />}>
            Mais filtros
          </Btn>
        </div>
      </div>
        ...
        <div className="overflow-auto">
          <table className="w-full text-[12.5px]">
            <thead className="sticky top-0 z-10" style={{ background: 'var(--surface-card)' }}>
              ...
              >
                <th className="text-left text-[10px] uppercase tracking-wider font-semibold py-3 pl-8 w-[88px]">
                  ID
                </th>
                ...
                <th className="text-right text-[10px] uppercase tracking-wider font-semibold py-3 pr-4">
                  Vence em
                </th>
              </tr>
            </thead>
            <tbody>
              {NC_ROWS.map((r, i) => (
                ...
                >
                  <td
                    className="py-3 pl-8 font-mono text-[11.5px]"
                    style={{ color: i === 0 ? 'var(--accent-600)' : 'var(--text-muted)' }}
                  >
                    {r.id}
                  </td>
                  ...
                  <td className="py-3">
                    <span className="text-[11.5px]" style={{ color: 'var(--text-body)' }}>
                      {r.sector}
                    </span>
                  </td>
                  <td className="py-3">
                    <Badge
                      tone={
                        r.sev === 'Crítica' ? 'danger' : r.sev === 'Maior' ? 'warning' : 'neutral'
                      }
                    >
                      {r.sev}
                    </Badge>
                  ...
                  <td className="py-3 text-[11.5px]" style={{ color: 'var(--text-body)' }}>
                    {r.owner}
                  </td>
                  <td
                    className="py-3 pr-4 text-right font-mono text-[11.5px]"
                    style={{ color: r.overdue ? 'var(--danger-500)' : 'var(--text-body)' }}
                  >
                    {r.overdue ? `-${r.due}d` : `${r.due}d`}
                  </td>
                </tr>
              ))}
            </tbody>
...
const NC_ROWS = [
  {
    id: 'NC-2026-041',
    title: 'Westgard 1-3s recorrente · Creatinina Nv2',
    source: 'CQI · Bioquímica · BQ-1812',
    sector: 'Bioquímica',
    sev: 'Crítica',
    capa: null,
    owner: 'Ana Pereira',
  ...
  {
    id: 'NC-2026-040',
    title: 'Temperatura geladeira > 8°C (pico 9.4°C)',
    source: 'Sensor T-04 · Geladeira reagentes',
    sector: 'Geral',
    sev: 'Maior',
    capa: 'CAPA-202',
    owner: 'Renata C.',
  ...
  {
    id: 'NC-2026-039',
    title: 'Calibração Cobas c311 vencida',
    source: 'Equipamento · Bioquímica',
    sector: 'Bioquímica',
    sev: 'Maior',
    capa: null,
    owner: 'Carlos M.',
  ...
  {
    id: 'NC-2026-038',
    title: 'Aviso 1-2s recorrente · HGB Nv2',
    source: 'CQI · Hematologia · HC-2904',
    sector: 'Hematologia',
    sev: 'Menor',
    capa: 'CAPA-199',
    owner: 'Renata C.',
  ...
  {
    id: 'NC-2026-037',
    title: 'Operador não treinado executou TP',
    source: 'Auditoria interna · Coag',
    sector: 'Coagulação',
    sev: 'Maior',
    capa: 'CAPA-198',
    owner: 'Carlos M.',
  ...
  {
    id: 'NC-2026-036',
    title: 'Bula desatualizada · CRE',
    source: 'Bioquímica · BQ-1812',
    sector: 'Bioquímica',
    sev: 'Menor',
    capa: null,
    owner: 'Ana Pereira',
  ...
  {
    id: 'NC-2026-035',
    title: 'Reclamação cliente · atraso liberação',
    source: 'Cliente externo',
    sector: 'Pré/Pós',
    sev: 'Menor',
    capa: 'CAPA-197',
    owner: 'Suzana L.',
  ...
  {
    id: 'NC-2026-034',
    title: 'Falha autoclave · ciclo abortado',
    source: 'Biossegurança',
    sector: 'Geral',
    sev: 'Maior',
    capa: 'CAPA-196',
    owner: 'Carlos M.',
...
function NCDetailDrawer() {
  return (
    <aside
      ...
      style={{ borderLeft: '1px solid var(--border-soft)', background: 'var(--surface-card)' }}
    >
      <div
      ...
      <div className="px-5 py-4 space-y-4">
        ...
        <Section title="Descrição">
          <p className="text-[12.5px] leading-relaxed" style={{ color: 'var(--text-body)' }}>
            ...
            Última corrida: 14.50 com z-score +3.14. Padrão de drift positivo sugere problema
            sistêmico no calibrador ou reagente. Bloqueio automático de liberação ativo.
          </p>
        </Section>
        ...
        <Section title="Próxima ação obrigatória" tone="danger">
          <div className="text-[12.5px] mb-2" style={{ color: 'var(--text-body)' }}>
            Atribuir CAPA com causa raiz e plano corretivo nos próximos <strong>2 dias</strong>.
          </div>
  ...
  return (
    <div>
      ...
      <div
        ...
        style={{
          color: tone === 'danger' ? 'var(--danger-500)' : 'var(--text-strong)',
          fontWeight: 500,
        }}
      >
        {value}
  ...
  return (
    <div
      ...
      style={{
        ...
        border:
          tone === 'danger' ? '1px solid var(--danger-500)' : '1px solid var(--border-hairline)',
      }}
    >
      <div
        className="text-[10px] uppercase tracking-wider font-semibold mb-2"
        style={{ color: tone === 'danger' ? 'var(--danger-500)' : 'var(--text-faint)' }}
      >
        {title}
      </div>
      {children}
...
const TIMELINE = [
  {
    tone: 'danger',
    title: 'Westgard 1-3s · 14.50 g/dL · z +3.14',
    when: '13 mai 06:50',
    by: 'sistema · CQI',
  },
  {
    tone: 'warn',
    title: 'Westgard 1-2s · 14.21 g/dL · z +2.11',
    when: '11 mai 07:02',
    by: 'sistema · CQI',
  },
  {
  ...
  return (
    <Shell page="auditoria">
      <PageHeader
        ...
        subtitle={
          <>
            Cadeia HMAC · hash root <span className="font-mono">b91f…73a2</span> · 2.4M eventos ·
            íntegro
          </>
        }
        actions={
          <>
            ...
            <Btn kind="secondary" size="md" icon={<I.Shield size={13} />}>
              Verificar cadeia
            </Btn>
          </>
        }
      ...
      >
        ...
        <Seg
          options={[
            ...
            { value: 'wr', label: 'Escrita' },
            { value: 'rd', label: 'Leitura' },
            { value: 'auth', label: 'Auth' },
          ]}
          active="all"
        />
        <input
          placeholder="actor · target · action · payload contains…"
          className="ml-auto w-[420px] px-3 h-8 rounded-md text-[12px] font-mono"
          style={{ background: 'var(--surface-muted)', color: 'var(--text-body)' }}
        />
      </div>
      ...
      <div className="px-8 py-5 overflow-auto h-[calc(100%-180px)]">
        <div
          className="text-[10px] uppercase tracking-wider font-semibold mb-3 flex items-center gap-2"
          style={{ color: 'var(--text-faint)' }}
        >
        ...
        <ol className="space-y-2">
          {AUDIT.map((a, i) => (
            ...
            >
              <div
                className="font-mono text-[11px] tabular-nums w-[64px] shrink-0"
                style={{ color: 'var(--text-faint)' }}
              >
                {a.time}
              </div>
              ...
              <div className="min-w-0 flex-1">
                <div className="text-[12.5px]" style={{ color: 'var(--text-strong)' }}>
                  ...
                  <span className="font-mono text-[11.5px]" style={{ color: 'var(--accent-600)' }}>
                    {a.target}
                  </span>
                </div>
                {a.detail && (
...
const AUDIT = [
  {
    time: '07:38:21',
    kind: 'write',
    actor: 'Renata Coutinho',
    verb: 'aprovou corrida',
    target: 'runs/abc1f3',
    detail: 'HGB · HC-2904 · z +0.79',
    ip: '10.0.4.12',
    seq: '2418991',
  },
  {
    time: '07:31:08',
    kind: 'write',
    actor: 'Carlos Marques',
    verb: 'iniciou corrida',
    target: 'runs/9d2e44',
    detail: 'TP · CG-0457 · operador validado',
    ip: '10.0.4.18',
    seq: '2418988',
  },
  {
    ...
    kind: 'auth',
    actor: 'Ana Pereira',
    verb: 'autenticou via SSO',
    target: '/auth',
    detail: 'MFA ok · device fingerprint 8f31…',
    ip: '10.0.4.21',
    seq: '2418984',
  },
  {
    ...
    kind: 'delete',
    actor: 'Renata Coutinho',
    verb: 'rejeitou corrida (Westgard 1-3s)',
    target: 'runs/ce40a2',
    detail: 'CRE · BQ-1812 · z +3.14 · bloqueio acionado',
    ip: '10.0.4.12',
    seq: '2418972',
  },
  {
    ...
    kind: 'write',
    actor: 'sistema',
    verb: 'abriu NC automaticamente',
    target: 'ncs/041',
    detail: 'origem: Westgard 1-3s · severidade Crítica',
    ip: '—',
    seq: '2418968',
  },
  {
    time: '06:58:31',
    kind: 'read',
    actor: 'Suzana L. (médico)',
    verb: 'consultou resultado liberado',
    target: 'reports/r-9931',
    detail: 'paciente 51********95 · acesso autorizado',
    ip: '200.187.x.x',
    seq: '2418955',
  },
  {
  ...
  },
  {
    ...
    kind: 'auth',
    actor: 'Diego R.',
    verb: 'tentativa de acesso negada',
    target: '/admin/users',
    detail: 'role member, requer superAdmin',
    ip: '10.0.4.30',
    seq: '2418901',
  },
];
...
function NotivisaScreen() {
  return (
    <Shell page="notivisa">
      <PageHeader
        title="NOTIVISA · Notificação tecnovigilância"
        ...
        actions={
          <>
            ...
            <Btn kind="secondary" size="md" icon={<I.Doc size={13} />}>
              Salvar rascunho
            </Btn>
            <Btn kind="primary" size="md" icon={<I.Upload size={13} />}>
              Submeter ANVISA
            </Btn>
          </>
        }
        ...
        <aside>
          ...
          <nav className="space-y-1">
            {[
              ...
              <a
                key={s.id}
                className="flex items-center gap-2.5 px-2.5 h-8 rounded-md text-[12.5px] cursor-pointer"
                style={{
          ...
          <div
            ...
            style={{ background: 'var(--accent-50)', border: '1px solid var(--accent-600)' }}
          >
            <div className="text-[11px] font-semibold" style={{ color: 'var(--accent-600)' }}>
              Pré-validado · ANVISA
            </div>
            <p className="text-[11px] mt-1 leading-snug" style={{ color: 'var(--text-body)' }}>
              Formulário segue RDC 67/2009 · cmpos obrigatórios serão verificados antes da
              submissão.
            </p>
          </div>
        </aside>
        ...
        <Card title="Evento adverso · seção 3 de 6" padded={false}>
          <div className="p-5 space-y-5">
            <Field label="Data e hora da ocorrência *" mono>
              <input
                defaultValue="08/05/2026 06:49"
                className="w-full px-3 h-9 rounded-md font-mono text-[13px]"
            ...
            <Field label="Tipo de evento *">
              <div className="grid grid-cols-3 gap-2">
                {[
                  ...
                  <button
                    key={t}
                    className="px-3 h-9 text-[12.5px] rounded-md text-left"
                    style={{
                      background: i === 0 ? 'var(--accent-tint)' : 'var(--surface-card)',
                      color: i === 0 ? 'var(--accent-600)' : 'var(--text-body)',
                      border:
                        i === 0 ? '1px solid var(--accent-600)' : '1px solid var(--border-soft)',
            ...
            <div className="grid grid-cols-2 gap-4">
              <Field label="Gravidade *" error="Selecione uma opção">
                <select
                  className="w-full px-3 h-9 rounded-md text-[13px]"
                  style={{
              ...
              <Field label="Causou dano ao paciente? *">
                <div className="flex gap-2">
                  {['Não', 'Sim · sem sequela', 'Sim · com sequela', 'Óbito'].map((o) => (
                    <button
                      key={o}
                      className="flex-1 px-2 h-9 text-[12px] rounded-md"
                      style={{
                        background: 'var(--surface-muted)',
                        color: 'var(--text-body)',
            ...
            <Field label="Descrição livre do evento *">
              ...
              />
              <div
                className="mt-1 flex justify-between text-[10px] font-mono"
                style={{ color: 'var(--text-faint)' }}
              >
          ...
          >
            <Btn kind="ghost" size="md" icon={<I.ChevL size={13} />}>
              Anterior · Produto
            </Btn>
            <span className="ml-3 text-[11px]" style={{ color: 'var(--text-muted)' }}>
              2 campos pendentes
            </span>
            <Btn kind="primary" size="md" className="ml-auto">
              Próximo · Paciente <I.ChevR size={13} />
            </Btn>
          </div>
        </Card>
          ...
          <Card title="Resumo">
            <dl className="space-y-2 text-[12px]">
              <div className="flex justify-between">
                <dt style={{ color: 'var(--text-muted)' }}>Item</dt>
              ...
              <div className="flex justify-between">
                ...
                <dd style={{ color: 'var(--text-strong)' }}>Tecnovigilância</dd>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                <dt style={{ color: 'var(--text-muted)' }}>Prazo legal</dt>
                <dd className="font-mono" style={{ color: 'var(--text-strong)' }}>
                  15 mai · D-2
                </dd>
              </div>
              <div className="flex justify-between">
                <dt style={{ color: 'var(--text-muted)' }}>Progresso</dt>
                <dd className="font-mono" style={{ color: 'var(--text-strong)' }}>
                  2 / 6
                </dd>
              </div>
          ...
          <Card title="Validações ANVISA" padded={false}>
            <ul>
              {[
                ...
                <li
                  key={i}
                  className="px-4 py-2 flex items-center gap-2.5 text-[12px]"
                  style={{ borderTop: i === 0 ? 'none' : '1px solid var(--border-hairline)' }}
                >
                  <span
                    className="w-4 h-4 rounded-full flex items-center justify-center shrink-0"
                    style={{
                      background: v.ok ? 'var(--success-50)' : 'var(--danger-50)',
                      color: v.ok ? 'var(--success-500)' : 'var(--danger-500)',
                    }}
                  >
                    {v.ok ? (
                      <I.Check size={10} strokeWidth={3} />
                    ) : (
                      <I.X size={10} strokeWidth={3} />
                    )}
                  </span>
                  <span style={{ color: v.ok ? 'var(--text-body)' : 'var(--text-strong)' }}>
                    {v.text}
                  </span>
                </li>
              ))}
  ...
  return (
    <div>
      <label
        ...
        style={{ color: error ? 'var(--danger-500)' : 'var(--text-strong)' }}
      >
        {label}
      </label>
      {children}
      ...
      {error && (
        <div className="mt-1 text-[10.5px] font-medium" style={{ color: 'var(--danger-500)' }}>
          {error}
        </div>
      )}
    </div>
