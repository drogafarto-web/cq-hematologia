...
**DICQ Coverage (PROJECTED — `pending-blocker`):** 78.5% → **88%** PRE-AUDIT READY _only if_ BLOCKERS 1, 3, 4, 5 close. As of 2026-05-08 the projection is doc-driven, not code-driven. Reverted from preemptive ⭐ marker.
...
**DICQ Coverage (PROJECTED — `pending-blocker`):** 88% → **92%+** EXTERNAL AUDIT READY _only if_ all upstream blockers close and Phase 5 + Phase 9 earn code-level evidence. Reverted from preemptive ⭐ marker on 2026-05-08.
